...
function Request(uri, options) {
  ...
  // stringify query given in options if not given in URL
...
mixin(Request.prototype, {
  ...
  abort: function(err) {
    ...
    var abortHandler = function() {
      self.request.removeListener('close', abortHandler);
      self.request.removeListener('abort', abortHandler);
      if (err) {
        self._fireError(err, null);
      } else {
    ...
    self.request.on('close', abortHandler);
    self.request.on('abort', abortHandler);
